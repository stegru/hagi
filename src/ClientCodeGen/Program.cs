...
{
    using cs = Templates.cs;
    using bash = Templates.bash;
    ...
    class Program
    {
        ...
        private async Task GenerateCS()
        {
            ...
            string outputDir = Path.Combine(Program.GetSourceRootDir(), "../Hagi.GuestClient/Generated");
        ...
        private async Task GenerateBash()
        {
            ...
            string outputDir = Path.Combine(Program.GetSourceRootDir(), "../Hagi.HostServer/Scripts");
            Directory.CreateDirectory(outputDir);
